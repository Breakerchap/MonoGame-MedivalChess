...
public static class UnitRules
{
  ...
  [
    ...
    new("Defender", RuleCategory.Melee, 2, RuleShape.Straight, 5, 30, 1, 1, 1, RuleShape.Straight, 20),
    ...
    new("Knight", RuleCategory.Melee, 3, RuleShape.Any, 20, 25, 1, 1, 1, RuleShape.Any, 40),
    new("Crossbowman", RuleCategory.Ranged, 2, RuleShape.Any, 20, 15, 1, 1, 3, RuleShape.Any, 45),
    new("Cavalier", RuleCategory.Melee, 4, RuleShape.Any, 15, 20, 1, 1, 1, RuleShape.Any, 40, 1, "May move and attack before spending its action."),
    ...
    new("Ox", RuleCategory.Transport, 4, RuleShape.Any, 5, 25, 1, 1, 1, RuleShape.Forward, 35, 1, "Carries one friendly unit or tows one Mechanical unit."),
    ...
    new("Guard", RuleCategory.Melee, 3, RuleShape.Any, 10, 25, 1, 1, 1, RuleShape.Any, 30, 1, "Attaches to a friendly unit and takes damage for it."),
    new("Mercenary", RuleCategory.Melee, 3, RuleShape.Any, 25, 20, 1, 1, 1, RuleShape.Any, 45, 1, "Place on a No-Man's-Land edge. An enemy can buy it for its last bid plus 10 gold."),
