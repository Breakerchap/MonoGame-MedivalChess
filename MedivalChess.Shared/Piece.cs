...
public static class PieceDefinitions
{
  ...
  public static readonly PieceDefinition Zeus = new(PieceType.Zeus, "ZEU", Pack.Greek, (2, Shape.Any), 30, 55, (1, 1), (1, 4), Shape.Circle, 140, "Its attack can chain to enemies adjacent to the target and enemies next to that one etc. Deals 20 damage");
