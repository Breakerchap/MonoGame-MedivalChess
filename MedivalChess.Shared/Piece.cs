...
public static class PieceDefinitions
{
  ...
  public static readonly PieceDefinition President = new(PieceType.President, "PRE", Pack.Modern, (3, Shape.Circle), 40, 220, (1, 1), (1, 2), Shape.Straight, 0, "Costs 5 gold per turn to maintain. Lose if you cannot afford it.");
  ...
  // Chess
  public static readonly PieceDefinition Pawn = new(PieceType.Pawn, "Pwn", Pack.Chess, (2, Shape.Forward), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 20, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition ChessKnight = new(PieceType.ChessKnight, "KnC", Pack.Chess, (3, Shape.ChessKnight), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 60, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.", displayName: "Chess Knight");
  public static readonly PieceDefinition Bishop = new(PieceType.Bishop, "Bsh", Pack.Chess, (8, Shape.Diagonal), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 60, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition Rook = new(PieceType.Rook, "Rok", Pack.Chess, (8, Shape.Line), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 100, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition Queen = new(PieceType.Queen, "Qun", Pack.Chess, (8, Shape.LineOrDiagonal), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 180, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition ChessKing = new(PieceType.ChessKing, "KIC", Pack.Chess, (1, Shape.Any), 120, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.", displayName: "Chess King");
