...
public static class PieceDefinitions
{
  ...
  // Chess -- unchanged
  public static readonly PieceDefinition Pawn = new(PieceType.Pawn, "Pwn", Pack.Chess, ((2, 2), Shape.Forward), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition ChessKnight = new(PieceType.ChessKnight, "KnC", Pack.Chess, ((3, 3), Shape.ChessKnight), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.", displayName: "Chess Knight");
  public static readonly PieceDefinition Bishop = new(PieceType.Bishop, "Bsh", Pack.Chess, ((8, 8), Shape.Diagonal), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition Rook = new(PieceType.Rook, "Rok", Pack.Chess, ((8, 8), Shape.Line), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition Queen = new(PieceType.Queen, "Qun", Pack.Chess, ((8, 8), Shape.LineOrDiagonal), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.");
  public static readonly PieceDefinition ChessKing = new(PieceType.ChessKing, "KIC", Pack.Chess, ((1, 1), Shape.Any), 60, 5, (1, 1), (0, 0), Shape.MoveOnEnemy, 0, "Attack a unit by landing on them; if they die, move onto the square they were on, else go to the previous square of your movement.", displayName: "Chess King");
