...
public class UpdatedRulesTests
{
  ...
  public void WorkbookStats_AreAppliedToEveryAvailableUnit()
  {
    ...
    AssertDefinition(PieceDefinitions.Defender, PieceCategory.Melee, 2, Shape.Straight, 5, 30, (1, 1), 1, Shape.Straight, 25);
    AssertDefinition(PieceDefinitions.Archer, PieceCategory.Ranged, 2, Shape.Any, 10, 10, (1, 1), 4, Shape.Any, 30, 2);
    ...
    AssertDefinition(PieceDefinitions.Spy, PieceCategory.Intelligence, 5, Shape.Any, 0, 15, (1, 1), 3, Shape.Any, 35, 1);
    ...
    AssertDefinition(PieceDefinitions.Elephant, PieceCategory.Melee, 2, Shape.Straight, 15, 50, (2, 2), 1, Shape.Any, 60);
